  ...
  return (
    <div className="container">
      <div className=" h-fit bg-gray-400 m-10">
        <div className="w-full flex items-center gap-4 justify-center flex-col p-10">
          ...
          <div className="w-[200px] md:w-[700px] text-center">
            <p>
              ...
              my technical skills and creativity to contribute to dynamic and
              innovative projects. My proficiency in crafting responsive and
              user-friendly interfaces, coupled with my understanding of state
            ...
            <p>
              ...
              prospect of contributing my skills and enthusiasm to a dynamic
              team, I am eager to explore opportunities that allow me to make
              meaningful contributions and further develop my expertise in web
              development.
            </p>
          </div>
        </div>
